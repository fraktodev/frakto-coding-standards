...
export default {
	...
	create(context) {
		...
		/**
		 * Align variable declarations in a given node.
		 *
		 * @param {ASTNode} node - The node to align variable declarations in.
		 * @returns {void}
		 */
		const alignVariables = (node) => {
		...
		return {
			VariableDeclaration: alignVariables
		};
	}
};
